...
export interface ApiInsuranceContractInsuranceContract
  extends Struct.CollectionTypeSchema {
...
export interface ApiTaskTask extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::task.task'> &
      Schema.Attribute.Private;
    person_charge: Schema.Attribute.Relation<
      'manyToMany',
      'plugin::users-permissions.user'
    >;
    ...
    type: Schema.Attribute.Enumeration<['reminder', 'fee_reminder']> &
      Schema.Attribute.DefaultTo<'reminder'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    created_tasks: Schema.Attribute.Relation<'oneToMany', 'api::task.task'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
